    ...
    <div className="app-shell">
      ...
      <main className="main-content">
        ...
        <div className="page-content">
          ...
          {view === 'settings' && <SettingsView preferences={preferences} setPreferences={(next) => { setPreferences(next); savePreferences(next) }} provider={provider} onNotice={showNotice} onDisconnect={() => { const next = clearDeviceLinkage(); setPreferences(next); lock() }} onExport={exportBackup} onImport={importBackup} onConnectExisting={connectExisting} />}
